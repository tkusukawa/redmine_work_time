...
Redmine::Plugin.register :redmine_work_time do
  ...
  project_module :work_time do
    permission :view_work_time_tab, {:work_time =>
            [:show,:total,:edit_relay,:relay_total,:popup_select_ticket,:ajax_select_ticket,:popup_select_tickets,:ajax_select_tickets,:ajax_insert_daily,:ajax_memo_edit,:ajax_relay_table]}
